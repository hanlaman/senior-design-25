...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("azure-native_cognitiveservices_v20250401preview");
			params.setVersion("3.12.1");
			params.setValue(Uint8Array.from(atob("ZXlKdGIyUjFiR1VpT2lKamIyZHVhWFJwZG1WelpYSjJhV05sY3lJc0luWmxjbk5wYjI0aU9pSjJNakF5TlRBME1ERndjbVYyYVdWM0luMD0="), c => c.charCodeAt(0)));

			const req = new resproto.RegisterPackageRequest();
			req.setName("azure-native");
			req.setVersion("3.12.1");
			req.setDownloadUrl("");
