...
export function getRaiPolicy(args: GetRaiPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetRaiPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native_cognitiveservices_v20250401preview:cognitiveservices:getRaiPolicy", {
...
export function getRaiPolicyOutput(args: GetRaiPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRaiPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native_cognitiveservices_v20250401preview:cognitiveservices:getRaiPolicy", {
        "accountName": args.accountName,
        "raiPolicyName": args.raiPolicyName,
        "resourceGroupName": args.resourceGroupName,
    }, opts, utilities.getPackage());
