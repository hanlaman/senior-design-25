...
export class AccountConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native_cognitiveservices_v20250401preview:cognitiveservices:AccountConnection';
    ...
    constructor(name: string, args: AccountConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20250601:AccountConnection" }, { type: "azure-native:cognitiveservices/v20250701preview:AccountConnection" }, { type: "azure-native:cognitiveservices/v20250901:AccountConnection" }, { type: "azure-native:cognitiveservices:AccountConnection" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(AccountConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
