...
export class CommitmentPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native_cognitiveservices_v20250401preview:cognitiveservices:CommitmentPlan';
