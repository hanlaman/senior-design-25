...
export class RaiBlocklistItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native_cognitiveservices_v20250401preview:cognitiveservices:RaiBlocklistItem';
    ...
    constructor(name: string, args: RaiBlocklistItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RaiBlocklistItem.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
