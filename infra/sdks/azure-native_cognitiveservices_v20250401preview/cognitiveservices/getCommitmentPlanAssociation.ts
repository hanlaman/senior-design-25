...
export function getCommitmentPlanAssociation(args: GetCommitmentPlanAssociationArgs, opts?: pulumi.InvokeOptions): Promise<GetCommitmentPlanAssociationResult> {
    ...
    return pulumi.runtime.invoke("azure-native_cognitiveservices_v20250401preview:cognitiveservices:getCommitmentPlanAssociation", {
...
export function getCommitmentPlanAssociationOutput(args: GetCommitmentPlanAssociationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCommitmentPlanAssociationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native_cognitiveservices_v20250401preview:cognitiveservices:getCommitmentPlanAssociation", {
        "commitmentPlanAssociationName": args.commitmentPlanAssociationName,
        "commitmentPlanName": args.commitmentPlanName,
        "resourceGroupName": args.resourceGroupName,
    }, opts, utilities.getPackage());
