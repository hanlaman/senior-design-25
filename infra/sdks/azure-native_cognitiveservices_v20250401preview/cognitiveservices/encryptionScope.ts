...
export class EncryptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native_cognitiveservices_v20250401preview:cognitiveservices:EncryptionScope';
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20231001preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240601preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20241001:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250601:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250701preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250901:EncryptionScope" }, { type: "azure-native:cognitiveservices:EncryptionScope" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(EncryptionScope.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
