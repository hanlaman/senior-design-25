...
export class CommitmentPlanAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native_cognitiveservices_v20250401preview:cognitiveservices:CommitmentPlanAssociation';
    ...
    constructor(name: string, args: CommitmentPlanAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20230501:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20231001preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20240601preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250601:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250701preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250901:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices:CommitmentPlanAssociation" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(CommitmentPlanAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
